...
prompt = f"Create me a schedule with {breaks} in between tasks. I want to start at {starting_time}. Give me just the schedule and no filler text. Fix any spelling mistakes and expand any acronyms and abbreviations. Expand on the schedule by completing including other things I should do for the rest of the day. This is the list of things I need to get done and the amount of time they will each take: {to_do_list}. Don't write anything in bold."
